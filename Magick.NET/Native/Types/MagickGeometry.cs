  ...
  public partial class MagickGeometry
  {
    private static class NativeMethods
    {
      public static class X64
      {
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern UIntPtr MagickGeometry_Initialize(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value);
      }
    ...
    private sealed class NativeMagickGeometry : NativeInstance
    {
      ...
      {
        if (NativeLibrary.Is64Bit)
          return (GeometryFlags)NativeMethods.X64.MagickGeometry_Initialize(Instance, value);
        else
          return (GeometryFlags)NativeMethods.X86.MagickGeometry_Initialize(Instance, value);
      }
    }
