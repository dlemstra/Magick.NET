  ...
  internal partial class DrawingSettings : IDisposable
  {
    private static class NativeMethods
    {
      public static class X64
      {
        ...
        public static extern string DrawingSettings_Font_Get(IntPtr instance);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingSettings_Font_Set(IntPtr instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8NoCleanupMarshaler))]
        public static extern string DrawingSettings_FontFamily_Get(IntPtr instance);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingSettings_FontFamily_Set(IntPtr instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8NoCleanupMarshaler))]
        public static extern string DrawingSettings_TextEncoding_Get(IntPtr instance);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingSettings_TextEncoding_Set(IntPtr instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingSettings_SetText(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
    ...
    private sealed class NativeDrawingSettings : NativeInstance
    {
      ...
      public MagickColor BorderColor
      {
        ...
        set
        {
          ...
          {
            if (NativeLibrary.Is64Bit)
              NativeMethods.X64.DrawingSettings_BorderColor_Set(Instance, valueDynamic.Instance);
            else
              NativeMethods.X86.DrawingSettings_BorderColor_Set(Instance, valueDynamic.Instance);
          }
        }
      }
      public MagickColor FillColor
      {
        ...
        set
        {
          ...
          {
            if (NativeLibrary.Is64Bit)
              NativeMethods.X64.DrawingSettings_FillColor_Set(Instance, valueDynamic.Instance);
            else
              NativeMethods.X86.DrawingSettings_FillColor_Set(Instance, valueDynamic.Instance);
          }
        }
      }
      ...
      public string Font
      {
        ...
        {
          if (NativeLibrary.Is64Bit)
            NativeMethods.X64.DrawingSettings_Font_Set(Instance, value);
          else
            NativeMethods.X86.DrawingSettings_Font_Set(Instance, value);
        }
      }
      public string FontFamily
      {
        ...
        {
          if (NativeLibrary.Is64Bit)
            NativeMethods.X64.DrawingSettings_FontFamily_Set(Instance, value);
          else
            NativeMethods.X86.DrawingSettings_FontFamily_Set(Instance, value);
        }
      }
      ...
      public MagickColor StrokeColor
      {
        ...
        set
        {
          ...
          {
            if (NativeLibrary.Is64Bit)
              NativeMethods.X64.DrawingSettings_StrokeColor_Set(Instance, valueDynamic.Instance);
            else
              NativeMethods.X86.DrawingSettings_StrokeColor_Set(Instance, valueDynamic.Instance);
          }
        }
      }
      ...
      public string TextEncoding
      {
        ...
        {
          if (NativeLibrary.Is64Bit)
            NativeMethods.X64.DrawingSettings_TextEncoding_Set(Instance, value);
          else
            NativeMethods.X86.DrawingSettings_TextEncoding_Set(Instance, value);
        }
      }
      ...
      public MagickColor TextUnderColor
      {
        ...
        set
        {
          ...
          {
            if (NativeLibrary.Is64Bit)
              NativeMethods.X64.DrawingSettings_TextUnderColor_Set(Instance, valueDynamic.Instance);
            else
              NativeMethods.X86.DrawingSettings_TextUnderColor_Set(Instance, valueDynamic.Instance);
          }
        }
      }
      ...
      {
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingSettings_SetText(Instance, value);
        else
          NativeMethods.X86.DrawingSettings_SetText(Instance, value);
      }
