  ...
  internal partial class DrawingWand : IDisposable
  {
    private static class NativeMethods
    {
      public static class X64
      {
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_ClipPath(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_Density(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_FillPatternUrl(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string url, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_FillRule(IntPtr Instance, UIntPtr value, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_Font(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string family, UIntPtr style, UIntPtr weight, UIntPtr stretch, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_Text(IntPtr Instance, double x, double y, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string text, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_PushClipPath(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string clipPath, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_PushGraphicContext(IntPtr Instance, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_PushPattern(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string id, double x, double y, double width, double height, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_StrokePatternUrl(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string value, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DrawingWand_TextEncoding(IntPtr Instance, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string encoding, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
    ...
    private sealed class NativeDrawingWand : NativeInstance
    {
      ...
      public void BorderColor(MagickColor value)
      {
        using (INativeInstance valueDynamic = MagickColor.CreateInstance(value))
        {
          IntPtr exception = IntPtr.Zero;
          if (NativeLibrary.Is64Bit)
            NativeMethods.X64.DrawingWand_BorderColor(Instance, valueDynamic.Instance, out exception);
          else
            NativeMethods.X86.DrawingWand_BorderColor(Instance, valueDynamic.Instance, out exception);
          CheckException(exception);
        }
      }
      ...
      public void ClipPath(string value)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_ClipPath(Instance, value, out exception);
        else
          NativeMethods.X86.DrawingWand_ClipPath(Instance, value, out exception);
        CheckException(exception);
      }
      ...
      public void Density(string value)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_Density(Instance, value, out exception);
        else
          NativeMethods.X86.DrawingWand_Density(Instance, value, out exception);
        CheckException(exception);
      }
      ...
      public void FillColor(MagickColor value)
      {
        using (INativeInstance valueDynamic = MagickColor.CreateInstance(value))
        {
          IntPtr exception = IntPtr.Zero;
          if (NativeLibrary.Is64Bit)
            NativeMethods.X64.DrawingWand_FillColor(Instance, valueDynamic.Instance, out exception);
          else
            NativeMethods.X86.DrawingWand_FillColor(Instance, valueDynamic.Instance, out exception);
          CheckException(exception);
        }
      }
      ...
      public void FillPatternUrl(string url)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_FillPatternUrl(Instance, url, out exception);
        else
          NativeMethods.X86.DrawingWand_FillPatternUrl(Instance, url, out exception);
        CheckException(exception);
      }
      ...
      public void Font(string family, FontStyleType style, FontWeight weight, FontStretch stretch)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_Font(Instance, family, (UIntPtr)style, (UIntPtr)weight, (UIntPtr)stretch, out exception);
        else
          NativeMethods.X86.DrawingWand_Font(Instance, family, (UIntPtr)style, (UIntPtr)weight, (UIntPtr)stretch, out exception);
        CheckException(exception);
      }
      ...
      public void Text(double x, double y, string text)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_Text(Instance, x, y, text, out exception);
        else
          NativeMethods.X86.DrawingWand_Text(Instance, x, y, text, out exception);
        CheckException(exception);
      }
      ...
      public void PushClipPath(string clipPath)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_PushClipPath(Instance, clipPath, out exception);
        else
          NativeMethods.X86.DrawingWand_PushClipPath(Instance, clipPath, out exception);
        CheckException(exception);
      }
      ...
      public void PushPattern(string id, double x, double y, double width, double height)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_PushPattern(Instance, id, x, y, width, height, out exception);
        else
          NativeMethods.X86.DrawingWand_PushPattern(Instance, id, x, y, width, height, out exception);
        CheckException(exception);
      }
      ...
      public void StrokeColor(MagickColor value)
      {
        using (INativeInstance valueDynamic = MagickColor.CreateInstance(value))
        {
          IntPtr exception = IntPtr.Zero;
          if (NativeLibrary.Is64Bit)
            NativeMethods.X64.DrawingWand_StrokeColor(Instance, valueDynamic.Instance, out exception);
          else
            NativeMethods.X86.DrawingWand_StrokeColor(Instance, valueDynamic.Instance, out exception);
          CheckException(exception);
        }
      }
      ...
      public void StrokePatternUrl(string value)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_StrokePatternUrl(Instance, value, out exception);
        else
          NativeMethods.X86.DrawingWand_StrokePatternUrl(Instance, value, out exception);
        CheckException(exception);
      }
      ...
      public void TextEncoding(string encoding)
      {
        IntPtr exception = IntPtr.Zero;
        if (NativeLibrary.Is64Bit)
          NativeMethods.X64.DrawingWand_TextEncoding(Instance, encoding, out exception);
        else
          NativeMethods.X86.DrawingWand_TextEncoding(Instance, encoding, out exception);
        CheckException(exception);
      }
      ...
      public void TextUnderColor(MagickColor color)
      {
        using (INativeInstance colorDynamic = MagickColor.CreateInstance(color))
        {
          IntPtr exception = IntPtr.Zero;
          if (NativeLibrary.Is64Bit)
            NativeMethods.X64.DrawingWand_TextUnderColor(Instance, colorDynamic.Instance, out exception);
          else
            NativeMethods.X86.DrawingWand_TextUnderColor(Instance, colorDynamic.Instance, out exception);
          CheckException(exception);
        }
      }
