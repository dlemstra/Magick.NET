  ...
  public partial class MagickFormatInfo
  {
    private static class NativeMethods
    {
      public static class X64
      {
        ...
        public static extern string MagickFormatInfo_Description_Get(IntPtr instance);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8NoCleanupMarshaler))]
        public static extern string MagickFormatInfo_Format_Get(IntPtr instance);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8NoCleanupMarshaler))]
        public static extern string MagickFormatInfo_MimeType_Get(IntPtr instance);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8NoCleanupMarshaler))]
        public static extern string MagickFormatInfo_Module_Get(IntPtr instance);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr MagickFormatInfo_GetInfoByName([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string name, out IntPtr exception);
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool MagickFormatInfo_Unregister([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string name);
      }
    ...
    private sealed class NativeMagickFormatInfo : ConstNativeInstance
    {
      ...
      public void GetInfoByName(string name)
      {
        ...
        IntPtr result;
        if (NativeLibrary.Is64Bit)
          result = NativeMethods.X64.MagickFormatInfo_GetInfoByName(name, out exception);
        else
          result = NativeMethods.X86.MagickFormatInfo_GetInfoByName(name, out exception);
        CheckException(exception);
        Instance = result;
      }
      ...
      {
        if (NativeLibrary.Is64Bit)
          return NativeMethods.X64.MagickFormatInfo_Unregister(name);
        else
          return NativeMethods.X86.MagickFormatInfo_Unregister(name);
      }
    }
  }
}
