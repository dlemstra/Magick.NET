  ...
  public partial class PixelCollection : IDisposable
  {
    private static class NativeMethods
    {
      public static class X64
      {
        ...
        [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr PixelCollection_ToByteArray(IntPtr Instance, UIntPtr x, UIntPtr y, UIntPtr width, UIntPtr height, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))] string mapping, out IntPtr exception);
      }
    ...
    private sealed class NativePixelCollection : NativeInstance
    {
      ...
      public IntPtr ToByteArray(int x, int y, int width, int height, string mapping)
      {
        ...
        IntPtr result;
        if (NativeLibrary.Is64Bit)
          result = NativeMethods.X64.PixelCollection_ToByteArray(Instance, (UIntPtr)x, (UIntPtr)y, (UIntPtr)width, (UIntPtr)height, mapping, out exception);
        else
          result = NativeMethods.X86.PixelCollection_ToByteArray(Instance, (UIntPtr)x, (UIntPtr)y, (UIntPtr)width, (UIntPtr)height, mapping, out exception);
