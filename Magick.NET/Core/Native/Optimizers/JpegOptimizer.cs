...
namespace ImageMagick.ImageOptimizers
{
  public partial class JpegOptimizer
  {
    ...
    {
      [SuppressMessage("Microsoft.Performance", "CA1810: InitializeReferenceTypeStaticFieldsInline", Scope = "member", Target = "ImageMagick.JpegOptimizer+NativeMethods.#.cctor()")]
