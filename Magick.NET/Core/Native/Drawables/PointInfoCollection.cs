...
namespace ImageMagick
{
  internal partial class PointInfoCollection : IDisposable
  {
    ...
    {
      [SuppressMessage("Microsoft.Performance", "CA1810: InitializeReferenceTypeStaticFieldsInline", Scope = "member", Target = "ImageMagick.PointInfoCollection+NativeMethods.#.cctor()")]
