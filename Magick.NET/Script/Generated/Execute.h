...
void ExecuteQuantizeColors(XmlElement^ element, MagickImage^ image);
void ExecuteQuantizeColorSpace(XmlElement^ element, MagickImage^ image);
void ExecuteQuantizeDither(XmlElement^ element, MagickImage^ image);
void ExecuteQuantizeTreeDepth(XmlElement^ element, MagickImage^ image);
