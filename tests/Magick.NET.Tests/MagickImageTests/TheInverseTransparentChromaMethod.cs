...
public partial class MagickImageTests
{
    public class TheInverseTransparentChromaMethod
    {
        ...
        public void ShouldThrowExceptionWhenColorLowIsNull()
        {
            ...
            {
                Assert.Throws<ArgumentNullException>("colorLow", () =>
                {
                    image.InverseTransparentChroma(null, MagickColors.Red);
                });
            }
        }
        ...
        public void ShouldThrowExceptionWhenColorHighIsNull()
        {
            using (var image = new MagickImage())
            {
                Assert.Throws<ArgumentNullException>("colorHigh", () =>
                {
                    image.InverseTransparentChroma(MagickColors.Red, null);
                });
            }
        }
