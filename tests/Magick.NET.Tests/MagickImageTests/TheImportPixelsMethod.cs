            ...
            public class WithByteArray
            {
                ...
                public void ShouldThrowExceptionWhenArrayIsNull()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        ...
                        {
                            image.ImportPixels((byte[])null, settings);
                        });
                    }
                }
                ...
                public void ShouldThrowExceptionWhenArrayIsEmpty()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        ...
                        {
                            image.ImportPixels(Array.Empty<byte>(), settings);
                        });
                ...
                public void ShouldThrowExceptionWhenMappingIsEmpty()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        ...
                        {
                            image.ImportPixels(new byte[] { 215 }, settings);
                        });
            ...
            public class WithByteArrayAndOffset
            {
                ...
                public void ShouldThrowExceptionWhenArrayIsNull()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        Assert.Throws<ArgumentNullException>("data", () =>
                        {
                            image.ImportPixels((byte[])null, 0, settings);
                        });
                    }
                }
                ...
                public void ShouldThrowExceptionWhenArrayIsEmpty()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        var exception = Assert.Throws<ArgumentException>("data", () =>
                        {
                            image.ImportPixels(Array.Empty<byte>(), 0, settings);
                        });
                        Assert.Contains("Value cannot be empty.", exception.Message);
                    }
                }
                ...
                public void ShouldThrowExceptionWhenSettingsIsNull()
                {
                    using (var image = new MagickImage())
                    {
                        Assert.Throws<ArgumentNullException>("settings", () =>
                        {
                            image.ImportPixels(new byte[] { 215 }, null);
                        });
                    }
                }
                ...
                public void ShouldThrowExceptionWhenOffsetIsNegative()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        ...
                        {
                            image.ImportPixels(new byte[] { 215 }, -1, settings);
                        });
                ...
                public void ShouldThrowExceptionWhenCountIsTooLow()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        ...
                        {
                            image.ImportPixels(new byte[] { 215, 215 }, 1, settings);
                        });
            ...
            public class WithQuantumArray
            {
                ...
                public void ShouldThrowExceptionWhenArrayIsNull()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        Assert.Throws<ArgumentNullException>("data", () =>
                        {
                            image.ImportPixels((QuantumType[])null, settings);
                        });
                    }
                }
                ...
                public void ShouldThrowExceptionWhenArrayIsEmpty()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        var exception = Assert.Throws<ArgumentException>("data", () =>
                        {
                            image.ImportPixels(Array.Empty<QuantumType>(), settings);
                        });
                        Assert.Contains("Value cannot be empty.", exception.Message);
                    }
                }
                ...
                public void ShouldThrowExceptionWhenMappingIsEmpty()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        var exception = Assert.Throws<ArgumentException>("settings", () =>
                        {
                            image.ImportPixels(new QuantumType[] { 215 }, settings);
                        });
                        Assert.Contains("Pixel storage mapping should be defined.", exception.Message);
                    }
                }
            ...
            public class WithQuantumArrayAndOffset
            {
                ...
                public void ShouldThrowExceptionWhenArrayIsNull()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        Assert.Throws<ArgumentNullException>("data", () =>
                        {
                            image.ImportPixels((QuantumType[])null, 0, settings);
                        });
                    }
                }
                ...
                public void ShouldThrowExceptionWhenArrayIsEmpty()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        var exception = Assert.Throws<ArgumentException>("data", () =>
                        {
                            image.ImportPixels(Array.Empty<QuantumType>(), 0, settings);
                        });
                        Assert.Contains("Value cannot be empty.", exception.Message);
                    }
                }
                ...
                public void ShouldThrowExceptionWhenSettingsIsNull()
                {
                    using (var image = new MagickImage())
                    {
                        Assert.Throws<ArgumentNullException>("settings", () =>
                        {
                            image.ImportPixels(new QuantumType[] { 215 }, null);
                        });
                    }
                }
                ...
                public void ShouldThrowExceptionWhenOffsetIsNegative()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        var exception = Assert.Throws<ArgumentException>("offset", () =>
                        {
                            image.ImportPixels(new QuantumType[] { 215 }, -1, settings);
                        });
                        Assert.Contains("The offset should be positive.", exception.Message);
                    }
                }
                ...
                public void ShouldThrowExceptionWhenCountIsTooLow()
                {
                    ...
                    using (var image = new MagickImage())
                    {
                        var exception = Assert.Throws<ArgumentException>("count", () =>
                        {
                            image.ImportPixels(new QuantumType[] { 215, 215 }, 1, settings);
                        });
                        Assert.Contains("The count is 2 but should be at least 4.", exception.Message);
                    }
                }
