...
namespace Magick.NET.Tests
{
  ...
  public class PerceptualHashTests
  {
    ...
    private PerceptualHash GetPerceptualHash(MagickImage image)
    {
      /* Rounding difference and AppVeyor does not support OpenCL so we need to disable it */
    ...
    public void Test_Channel()
    {
      ...
      {
        PerceptualHash phash = GetPerceptualHash(image);
