...
{
    [NativeInterop(QuantumType = true)]
    private unsafe sealed partial class NativeDrawingWand : NativeInstance
    {
        ...
        public static partial IntPtr Create(IMagickImage image, DrawingSettings settings);
        ...
        [Throws]
        [Instance(SetsInstance = false)]
        public partial void StrokeDashArray(double[] dash, int length);
