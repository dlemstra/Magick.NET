...
namespace ImageMagick
{
    public partial class MagickImageCollection
    {
        ...
        private sealed class NativeMagickImageCollection : NativeHelper
        {
            ...
            public IntPtr Append(IMagickImage<QuantumType> image, bool stack)
            {
            ...
            public IntPtr Coalesce(IMagickImage<QuantumType> image)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Combine(IMagickImage<QuantumType> image, ColorSpace colorSpace)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Complex(IMagickImage<QuantumType> image, ComplexOperator complexOperator)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Deconstruct(IMagickImage<QuantumType> image)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Evaluate(IMagickImage<QuantumType> image, EvaluateOperator evaluateOperator)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Merge(IMagickImage<QuantumType> image, LayerMethod method)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Montage(IMagickImage<QuantumType> image, IMontageSettings<QuantumType> settings)
            {
            ...
            public IntPtr Morph(IMagickImage<QuantumType> image, int frames)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Optimize(IMagickImage<QuantumType> image)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr OptimizePlus(IMagickImage<QuantumType> image)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public void OptimizeTransparency(IMagickImage<QuantumType> image)
            {
                IntPtr exception = IntPtr.Zero;
                #if PLATFORM_AnyCPU
                if (NativeLibrary.Is64Bit)
            ...
            public IntPtr Polynomial(IMagickImage<QuantumType> image, double[] terms, int length)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public IntPtr Smush(IMagickImage<QuantumType> image, int offset, bool stack)
            {
                IntPtr exception = IntPtr.Zero;
                IntPtr result;
                #if PLATFORM_AnyCPU
            ...
            public void WriteFile(IMagickImage<QuantumType> image, IMagickSettings<QuantumType> settings)
            {
                using (INativeInstance settingsNative = MagickSettings.CreateInstance(settings))
                {
                    IntPtr exception = IntPtr.Zero;
            ...
            public void WriteStream(IMagickImage<QuantumType> image, IMagickSettings<QuantumType> settings, ReadWriteStreamDelegate writer, SeekStreamDelegate seeker, TellStreamDelegate teller, ReadWriteStreamDelegate reader)
            {
                using (INativeInstance settingsNative = MagickSettings.CreateInstance(settings))
                {
                    IntPtr exception = IntPtr.Zero;
