    ...
    public partial class MagickImage : IDisposable
    {
        ...
        private static class NativeMethods
        {
            ...
            public static class X64
            {
                ...
                [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
                public static extern IntPtr MagickImage_InterpolativeResize(IntPtr Instance, UIntPtr width, UIntPtr height, UIntPtr method, out IntPtr exception);
                [DllImport(NativeLibrary.X64Name, CallingConvention = CallingConvention.Cdecl)]
        ...
        private sealed class NativeMagickImage : NativeInstance
        {
            ...
            public void Clut(IMagickImage image, PixelInterpolateMethod method, Channels channels)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                NativeMethods.X64.MagickImage_Clut(Instance, image.GetInstance(), (UIntPtr)method, (UIntPtr)channels, out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                NativeMethods.X86.MagickImage_Clut(Instance, image.GetInstance(), (UIntPtr)method, (UIntPtr)channels, out exception);
                #endif
                CheckException(exception);
            }
            ...
            public IntPtr Compare(IMagickImage image, ErrorMetric metric, Channels channels, out double distortion)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                result = NativeMethods.X64.MagickImage_Compare(Instance, image.GetInstance(), (UIntPtr)metric, (UIntPtr)channels, out distortion, out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                result = NativeMethods.X86.MagickImage_Compare(Instance, image.GetInstance(), (UIntPtr)metric, (UIntPtr)channels, out distortion, out exception);
                #endif
                CheckException(exception, result);
                return result;
            }
            public double CompareDistortion(IMagickImage image, ErrorMetric metric, Channels channels)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                result = NativeMethods.X64.MagickImage_CompareDistortion(Instance, image.GetInstance(), (UIntPtr)metric, (UIntPtr)channels, out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                result = NativeMethods.X86.MagickImage_CompareDistortion(Instance, image.GetInstance(), (UIntPtr)metric, (UIntPtr)channels, out exception);
                #endif
                CheckException(exception);
                return result;
            }
            public void Composite(IMagickImage image, int x, int y, CompositeOperator compose, Channels channels)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                NativeMethods.X64.MagickImage_Composite(Instance, image.GetInstance(), (IntPtr)x, (IntPtr)y, (UIntPtr)compose, (UIntPtr)channels, out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                NativeMethods.X86.MagickImage_Composite(Instance, image.GetInstance(), (IntPtr)x, (IntPtr)y, (UIntPtr)compose, (UIntPtr)channels, out exception);
                #endif
                CheckException(exception);
            }
            ...
            public void CopyPixels(IMagickImage image, MagickRectangle geometry, OffsetInfo offset, Channels channels)
            {
                using (INativeInstance geometryNative = MagickRectangle.CreateInstance(geometry))
                {
                    using (INativeInstance offsetNative = OffsetInfo.CreateInstance(offset))
                    {
                        ...
                        #endif
                        #if PLATFORM_x64 || PLATFORM_AnyCPU
                        NativeMethods.X64.MagickImage_CopyPixels(Instance, image.GetInstance(), geometryNative.Instance, offsetNative.Instance, (UIntPtr)channels, out exception);
                        #endif
                        #if PLATFORM_AnyCPU
                        else
                        #endif
                        #if PLATFORM_x86 || PLATFORM_AnyCPU
                        NativeMethods.X86.MagickImage_CopyPixels(Instance, image.GetInstance(), geometryNative.Instance, offsetNative.Instance, (UIntPtr)channels, out exception);
                        #endif
                        CheckException(exception);
                    }
                }
            ...
            public bool Equals(IMagickImage image)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                result = NativeMethods.X64.MagickImage_Equals(Instance, image.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                result = NativeMethods.X86.MagickImage_Equals(Instance, image.GetInstance(), out exception);
                #endif
                CheckException(exception);
                return result;
            }
            ...
            public void HaldClut(IMagickImage image)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                NativeMethods.X64.MagickImage_HaldClut(Instance, image.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                NativeMethods.X86.MagickImage_HaldClut(Instance, image.GetInstance(), out exception);
                #endif
                CheckException(exception);
            }
            ...
            public void InterpolativeResize(int width, int height, PixelInterpolateMethod method)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                result = NativeMethods.X64.MagickImage_InterpolativeResize(Instance, (UIntPtr)width, (UIntPtr)height, (UIntPtr)method, out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
            ...
            public bool Map(IMagickImage image, IQuantizeSettings settings)
            {
                using (INativeInstance settingsNative = QuantizeSettings.CreateInstance(settings))
                {
                    ...
                    #endif
                    #if PLATFORM_x64 || PLATFORM_AnyCPU
                    result = NativeMethods.X64.MagickImage_Map(Instance, image.GetInstance(), settingsNative.Instance, out exception);
                    #endif
                    #if PLATFORM_AnyCPU
                    else
                    #endif
                    #if PLATFORM_x86 || PLATFORM_AnyCPU
                    result = NativeMethods.X86.MagickImage_Map(Instance, image.GetInstance(), settingsNative.Instance, out exception);
                    #endif
                    CheckException(exception);
                    return result;
                }
            ...
            public void ReadBlob(IMagickSettings<QuantumType> settings, byte[] data, int offset, int length)
            {
                using (INativeInstance settingsNative = MagickSettings.CreateInstance(settings))
                {
                    ...
                    #endif
                    #if PLATFORM_x64 || PLATFORM_AnyCPU
                    result = NativeMethods.X64.MagickImage_ReadBlob(settingsNative.Instance, data, (UIntPtr)offset, (UIntPtr)length, out exception);
                    #endif
                    #if PLATFORM_AnyCPU
                    else
                    #endif
            ...
            public void ReadPixels(int width, int height, string map, StorageType storageType, byte[] data, int offset)
            {
                using (INativeInstance mapNative = UTF8Marshaler.CreateInstance(map))
                {
                    ...
                    #endif
                    #if PLATFORM_x64 || PLATFORM_AnyCPU
                    result = NativeMethods.X64.MagickImage_ReadPixels((UIntPtr)width, (UIntPtr)height, mapNative.Instance, (UIntPtr)storageType, data, (UIntPtr)offset, out exception);
                    #endif
                    #if PLATFORM_AnyCPU
                    else
                    #endif
            ...
            public bool SetColorMetric(IMagickImage image)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                result = NativeMethods.X64.MagickImage_SetColorMetric(Instance, image.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                result = NativeMethods.X86.MagickImage_SetColorMetric(Instance, image.GetInstance(), out exception);
                #endif
                CheckException(exception);
                return result;
            }
            ...
            public void SetReadMask(IMagickImage image)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                NativeMethods.X64.MagickImage_SetReadMask(Instance, image.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                NativeMethods.X86.MagickImage_SetReadMask(Instance, image.GetInstance(), out exception);
                #endif
                CheckException(exception);
            }
            public void SetWriteMask(IMagickImage image)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                NativeMethods.X64.MagickImage_SetWriteMask(Instance, image.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                NativeMethods.X86.MagickImage_SetWriteMask(Instance, image.GetInstance(), out exception);
                #endif
                CheckException(exception);
            }
            ...
            public void Stegano(IMagickImage watermark)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                result = NativeMethods.X64.MagickImage_Stegano(Instance, watermark.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
            ...
            public void Stereo(IMagickImage rightImage)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                result = NativeMethods.X64.MagickImage_Stereo(Instance, rightImage.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
            ...
            public IntPtr SubImageSearch(IMagickImage reference, ErrorMetric metric, double similarityThreshold, out MagickRectangle offset, out double similarityMetric)
            {
                using (INativeInstance offsetNative = MagickRectangle.CreateInstance())
                {
                    ...
                    #endif
                    #if PLATFORM_x64 || PLATFORM_AnyCPU
                    result = NativeMethods.X64.MagickImage_SubImageSearch(Instance, reference.GetInstance(), (UIntPtr)metric, similarityThreshold, offsetNativeOut, out similarityMetric, out exception);
                    #endif
                    #if PLATFORM_AnyCPU
                    else
                    #endif
                    #if PLATFORM_x86 || PLATFORM_AnyCPU
                    result = NativeMethods.X86.MagickImage_SubImageSearch(Instance, reference.GetInstance(), (UIntPtr)metric, similarityThreshold, offsetNativeOut, out similarityMetric, out exception);
                    #endif
            ...
            public void Texture(IMagickImage image)
            {
                ...
                #endif
                #if PLATFORM_x64 || PLATFORM_AnyCPU
                NativeMethods.X64.MagickImage_Texture(Instance, image.GetInstance(), out exception);
                #endif
                #if PLATFORM_AnyCPU
                else
                #endif
                #if PLATFORM_x86 || PLATFORM_AnyCPU
                NativeMethods.X86.MagickImage_Texture(Instance, image.GetInstance(), out exception);
                #endif
                CheckException(exception);
            }
