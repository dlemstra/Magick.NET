...
public sealed partial class MagickImageCollection : IMagickImageCollection<QuantumType>
{
    ...
    public Task PingAsync(Stream stream, IMagickReadSettings<QuantumType>? readSettings, CancellationToken cancellationToken)
        => AddImagesAsync(stream, readSettings, null, true, cancellationToken);
    ...
    public async Task PingAsync(string fileName, IMagickReadSettings<QuantumType>? readSettings, CancellationToken cancellationToken)
    {
        ...
        await AddImagesAsync(fileStream, readSettings, format, true, cancellationToken).ConfigureAwait(false);
    }
    ...
    public Task WriteAsync(string fileName, CancellationToken cancellationToken)
    {
        ...
        var formatInfo = MagickFormatInfo.Create(filePath);
        return WriteAsyncInternal(filePath, formatInfo?.Format, cancellationToken);
    }
