    ...
    public sealed partial class MagickScript
    {
        private void ExecuteMagickSettings(XmlElement element, MagickSettings settings)
        {
            switch(element.Name[0])
            {
                case 'a':
                {
                    ExecuteAntiAlias(element, settings);
                    return;
                }
                case 'b':
                {
        ...
        private void ExecuteAntiAlias(XmlElement element, MagickSettings settings)
        {
            settings.AntiAlias = GetValue<Boolean>(element, "value");
        }
        ...
        private void ExecuteDepth(XmlElement element, MagickSettings settings)
        {
            settings.Depth = GetValue<Int32>(element, "value");
        }
