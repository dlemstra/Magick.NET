...
namespace ImageMagick
{
    ...
    public struct Percentage : IEquatable<Percentage>, IComparable<Percentage>
    {
        ...
        public Percentage(double value) => _value = value;

        /// <summary>
        /// Initializes a new instance of the <see cref="Percentage"/> struct.
        /// </summary>
        /// <param name="value">The value (0% = 0, 100% = 100).</param>
        public Percentage(int value) => _value = value;
        ...
        public static explicit operator double(Percentage percentage) => percentage.ToDouble();

        /// <summary>
        /// Converts the <see cref="Percentage"/> to a quantum type.
        /// </summary>
        /// <param name="percentage">The <see cref="Percentage"/> to convert.</param>
        public static explicit operator int(Percentage percentage) => percentage.ToInt32();
        ...
        /// <param name="left">The first <see cref="Percentage"/> to compare.</param>
        /// <param name="right"> The second <see cref="Percentage"/> to compare.</param>
        public static bool operator >(Percentage left, Percentage right) => left.CompareTo(right) == 1;
        ...
        public static double operator *(double value, Percentage percentage) => percentage.Multiply(value);
        ...
        /// <param name="value"> The value to use.</param>
        /// <param name="percentage">The <see cref="Percentage"/> to use.</param>
        public static int operator *(int value, Percentage percentage) => percentage.Multiply(value);
        ...
        public double Multiply(double value) => (value * _value) / 100.0;
        ...
        /// <param name="value">The value to use.</param>
        /// <returns>the new value.</returns>
        public int Multiply(int value) => (int)((value * _value) / 100.0);
        ...
        public int ToInt32() => (int)Math.Round(_value, MidpointRounding.AwayFromZero);

        /// <summary>
        /// Returns a string that represents the current percentage.
        /// </summary>
        /// <returns>A string that represents the current percentage.</returns>
        public override string ToString() => string.Format(CultureInfo.InvariantCulture, "{0:0.##}%", _value);

        internal static Percentage FromQuantum(double value) => new Percentage((value / Quantum.Max) * 100);

        internal double ToQuantum() => Quantum.Max * (_value / 100);

        internal QuantumType ToQuantumType() => (QuantumType)(Quantum.Max * (_value / 100));
    }
}
