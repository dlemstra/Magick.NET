...
namespace ImageMagick
{
    ...
    public static partial class ExifValues
    {
        ...
        internal static ExifValue Create(ExifTagValue tag, ExifDataType dataType, uint numberOfComponents)
        {
            ...
            {
                ExifDataType.Byte => isArray ? (ExifValue)new ExifByteArray(tag, dataType) : new ExifByte(tag, dataType),
                ExifDataType.Double => isArray ? (ExifValue)new ExifDoubleArray(tag) : new ExifDouble(tag),
                ExifDataType.Float => isArray ? (ExifValue)new ExifFloatArray(tag) : new ExifFloat(tag),
                ExifDataType.Long => isArray ? (ExifValue)new ExifLongArray(tag) : new ExifLong(tag),
                ExifDataType.Rational => isArray ? (ExifValue)new ExifRationalArray(tag) : new ExifRational(tag),
                ExifDataType.Short => isArray ? (ExifValue)new ExifShortArray(tag) : new ExifShort(tag),
                ExifDataType.SignedByte => isArray ? (ExifValue)new ExifSignedByteArray(tag) : new ExifSignedByte(tag),
                ExifDataType.SignedLong => isArray ? (ExifValue)new ExifSignedLongArray(tag) : new ExifSignedLong(tag),
                ExifDataType.SignedRational => isArray ? (ExifValue)new ExifSignedRationalArray(tag) : new ExifSignedRational(tag),
                ExifDataType.SignedShort => isArray ? (ExifValue)new ExifSignedShortArray(tag) : new ExifSignedShort(tag),
                ExifDataType.String => new ExifString(tag),
                ExifDataType.Undefined => isArray ? (ExifValue)new ExifByteArray(tag, dataType) : new ExifByte(tag, dataType),
        ...
        internal static IExifValue CreateFromTagValue(ExifTagValue tag)
        {
        ...
        private static object CreateValue(ExifTagValue tag) => tag switch
        {
