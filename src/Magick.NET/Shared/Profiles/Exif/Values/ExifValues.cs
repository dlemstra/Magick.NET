    ...
    internal static partial class ExifValues
    {
        ...
        public static ExifValue Create(ExifTagValue tag, ExifDataType dataType, uint numberOfComponents)
        {
            ...
            switch (dataType)
            {
                ...
                case ExifDataType.Double: return isArray ? (ExifValue)new ExifDoubleArray(tag) : new ExifDouble(tag);
                case ExifDataType.Float: return isArray ? (ExifValue)new ExifFloatArray(tag) : new ExifFloat(tag);
                ...
                case ExifDataType.String: return new ExifString(tag);
