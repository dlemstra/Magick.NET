...
unzip Q8.zip -d Tests/Magick.NET.Tests/bin/TestQ8/AnyCPU/netcoreapp2.0/

dotnet test Tests/Magick.NET.Tests/Magick.NET.Tests.csproj -f netcoreapp2.0 -c TestQ8 --no-build