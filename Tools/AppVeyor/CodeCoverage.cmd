...
OpenCover.4.6.519\tools\OpenCover.Console.exe -target:"%VSINSTALLDIR%Common7\IDE\CommonExtensions\Microsoft\TestWindow\vstest.console.exe" -targetargs:"/platform:x86 /inIsolation ..\..\Tests\Magick.NET.Tests\bin\ReleaseQ8\x86\net45\Magick.NET.Tests.dll" -register:user -threshold:10 -excludebyattribute:*.ExcludeFromCodeCoverage* -excludebyfile:*\Generated\*.cs;*\MagickColors.cs -hideskipped:All -output:.\Magick.NET.Coverage.xml
