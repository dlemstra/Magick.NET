...
Write-Host "Downloading Ghostscript 10.01.0"
$sourceGhostscriptExe = "https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs10011/gs10011w32.exe"
$targetGhostscriptExe = "$PSScriptRoot\..\..\tools\windows\gs10011w32.exe"
