...
MAGICK_NET_EXPORT void MagickImage_CompositeGraviy(Image *, const Image *, const size_t, const size_t, const size_t, const size_t, const size_t, ExceptionInfo **);
...
MAGICK_NET_EXPORT void MagickImage_RangeThreshold(Image *, const double, const double, const double, const double, ExceptionInfo **);

MAGICK_NET_EXPORT Image *MagickImage_ReadBlob(const ImageInfo *, const unsigned char *, const size_t, const size_t, ExceptionInfo **);
...
MAGICK_NET_EXPORT void MagickImage_WriteStream(Image *, ImageInfo *, const CustomStreamHandler, const CustomStreamSeeker, const CustomStreamTeller, const CustomStreamHandler, ExceptionInfo **);